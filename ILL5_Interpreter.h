...
PRS   print TopOfStack elements below top of stack, as ASCII chars, and then pop the stack by (TopOfStack + 1) elements
...
void interpreter::loadCode(void)
{
	...
	for (i = 0; i <= codeMax; i++)
	{
		memory.pCode[i].op = nul; // fill the rest with invalid op-code
